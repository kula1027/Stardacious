...
public class StartSceneManager : MonoBehaviour {
	...
	public void OnRecv(NetworkMessage networkMessage){
		...
		case MsgAttr.Misc.failConnect:
			...
			KingGodClient.instance.OnConnectionFailed();
			break;
		...
		case MsgAttr.Misc.udpPort:
			int portServer = int.Parse(networkMessage.Body[0].Content);
			ConsoleMsgQueue.EnqueMsg("Server Recv Port: " + portServer);
			Network_Client.InitUdp(portServer);
			break;
		...
		case MsgAttr.Misc.letsgo:
			...
			SceneManager.LoadSceneAsync(SceneName.scNameInGame);
			break;
		}
	}
